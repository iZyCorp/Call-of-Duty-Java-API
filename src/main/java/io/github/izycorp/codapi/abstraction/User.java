...
public class User {
    ...
    public JSONObject searchPlayer(String playerName, Platform platform, String ssoToken) throws CodServerException {
    ...
    public JSONObject getIdentities(String unoId, String ssoToken) throws CodServerException {
     ...
     */
    @Route(requestRoute = RequestRoute.PROTECTED)
    public JSONObject getFriends(String ssoToken) throws CodServerException {
     ...
     */
    @Route(requestRoute = RequestRoute.PROTECTED)
    public JSONObject performFriendAction(FriendAction friendAction, Platform platform, String lookupType, String gamerTag, String ssoToken) throws CodServerException {
