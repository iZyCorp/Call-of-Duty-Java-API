...
class ModernWarfare2019Test {

    private ModernWarfare2019 mw2019;
    ...
    void setUp() {
        ...
        mw2019 = new ModernWarfare2019(requestManager);
    }
    ...
    void testGetLeaderboard() throws CodRequestException {
        final Page page = mw2019.getLeaderboard(
                Platform.PLAYSTATION,
                TimeFrame.ALLTIME,
                Gamemode.CAREER,
                GameType.CORE,
    ...
    void testGetPlayerLeaderboard() throws CodRequestException {
        final Page page = mw2019.getPlayerLeaderboard(
                Gamemode.CAREER,
                GameType.CORE,
                Platform.PLAYSTATION,
                TimeFrame.ALLTIME,
