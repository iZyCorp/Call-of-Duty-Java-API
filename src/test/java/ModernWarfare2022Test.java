...
import io.github.izycorp.codapi.title.ModernWarfare2022;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

class ModernWarfare2022Test {

    private ModernWarfare2022 mw2022;
    ...
    void setUp() {
        ...
        mw2022 = new ModernWarfare2022(requestManager);
    }
    ...
    void testGetUserMatches() throws CodRequestException {
        final Page page = mw2022.getUserMatches(
                Gamemode.MULTIPLAYER,
                Platform.STEAM,
                dotenv.get("ACT_USERNAME"),
                10,
